<!-- Bootstrap -->
<link rel="stylesheet" href="{$WEB_ROOT}/templates/{$template}/css/flexslider.css" type="text/css">
...
<script src="{$WEB_ROOT}/templates/{$template}/js/jquery.flexslider.js"></script>
